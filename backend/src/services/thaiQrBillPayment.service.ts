...
export class ThaiQrBillPaymentService {
  ...
  public static async getActiveBillerConfig(): Promise<{
    ...
    try {
      ...
      if (res.rows.length > 0) {
        ...
        return {
          ...
          soapUrl: row.soap_url || process.env.KU_QR_SOAP_URL || 'https://fin.ku.th/qr/service',
          billerSuffix: row.biller_suffix || process.env.KU_QR_BILLER_SUFFIX || '50',
    ...
    return {
      ...
      billerSuffix: process.env.KU_QR_BILLER_SUFFIX || '50',
