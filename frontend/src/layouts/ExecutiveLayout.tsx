...
import { ExecutivePortal } from '../pages/ExecutivePortal.js';
...
export const ExecutiveLayout: React.FC<ExecutiveLayoutProps> = ({
  ...
  // Guard check: If not executive or admin
      ...
      <div className="min-h-screen bg-slate-100 flex flex-col items-center justify-center p-4">
        <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-xl border border-slate-200 text-center space-y-4">
          ...
          <h2 className="text-lg font-black text-slate-800">
            รายงานและแดชบอร์ดสรุปภาพรวมสำหรับผู้บริหาร
          </h2>
          <p className="text-xs text-slate-500 leading-relaxed">
            หน้านี้สงวนสิทธิ์เฉพาะผู้บริหารระดับสูงและผู้ดูแลระบบ มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตเฉลิมพระเกียรติ จังหวัดสกลนคร เพื่อดูภาพรวมสถิติและผลการดำเนินงาน
          </p>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
      ...
      <header className="bg-white border-b border-slate-200 shadow-sm sticky top-0 z-40 select-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center justify-between">
          ...
          {/* Right: Executive Profile, Return to Student, and Logout */}
          <div className="flex items-center space-x-3">
            <button
              onClick={() => navigate('/')}
            ...
            <div className="flex items-center space-x-2 pl-2 border-l border-slate-200">
              <div className="hidden sm:block text-right">
                ...
                <div className="text-[10px] text-purple-700 font-semibold flex items-center justify-end space-x-1">
      ...
      <footer className="bg-white border-t border-slate-200 py-3 text-center text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px]">
          <div>
            📊 ข้อมูลสถิติเชิงกลยุทธ์เพื่อการตัดสินใจและพัฒนาคุณภาพการบริการการศึกษา
          </div>
          <div className="text-slate-400">
            ระบบจัดเก็บและวิเคราะห์ข้อมูลแบบเรียลไทม์ (Real-time Analytics)
          </div>
        </div>
      </footer>
    </div>
